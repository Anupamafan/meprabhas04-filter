...
API_ID = int(environ.get('API_ID', '5606197'))
API_HASH = environ.get('API_HASH', 'e705c08cb069aa050e4397721fbeaa45')
BOT_TOKEN = environ.get('BOT_TOKEN', "1728045492:AAGCcNCnVSYC9isi1rZQTHq1-fu4p4nLHb4")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1805655450').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001210893367').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1001210893367') # give your force subscribe channel id here else leave it blank
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Movies_Telugu_Top')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/Movies-Telugu-Top-05-01')
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/How_To_Open_shortLinks/23')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'e11fdc88060dffdaf4e0f18ed57336d6c94a7a68')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://public-dina-darling-prabhas-9ce6b73c.koyeb.app/")
